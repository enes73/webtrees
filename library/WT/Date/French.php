	...
	public static function monthNameNominativeCase($month_number, $leap_year) {
		...
		if ($translated_month_names === null) {
			$translated_month_names = array(
				...
				12 => /* I18N: a month in the French republican calendar */ WT_I18N::translate_c('NOMINATIVE', 'jours complémentaires'),
			);
		}
	...
	static function monthNameGenitiveCase($month_number, $leap_year) {
		...
		if ($translated_month_names === null) {
			$translated_month_names = array(
				...
				12 => /* I18N: a month in the French republican calendar */ WT_I18N::translate_c('GENITIVE', 'jours complémentaires'),
			);
		}
	...
	static function monthNameLocativeCase($month_number, $leap_year) {
		...
		if ($translated_month_names === null) {
			$translated_month_names = array(
				...
				12 => /* I18N: a month in the French republican calendar */ WT_I18N::translate_c('LOCATIVE', 'jours complémentaires'),
			);
		}
	...
	static function monthNameInstrumentalCase($month_number, $leap_year) {
		...
		if ($translated_month_names === null) {
			$translated_month_names = array(
				...
				12 => /* I18N: a month in the French republican calendar */ WT_I18N::translate_c('INSTRUMENTAL', 'jours complémentaires'),
			);
		}
